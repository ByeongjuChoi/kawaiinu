...
public class CommentsDTO {
	...
	private Long feedid;     	// 댓글이 달린 게시물 ID (FeedEntity의 feedid)
	private String comments; 	// 댓글 내용
	private LocalDateTime commentsCreatedDate;  // 댓글 작성 시간
	
	// 생성자, getter, setter 등
    public CommentsDTO(Long commentsid, Long feedid, String userid, String comments, LocalDateTime commentscreatedate) {
